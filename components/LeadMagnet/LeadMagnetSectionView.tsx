...
import { questionWord } from "@/lib/questionnaireLabel";
import LeadMagnetModal from "./LeadMagnetModal";

// Feste Vorschau-Fragen: Sie sind auf die Sektion zugeschnitten und bleiben
// bewusst unabhängig von der Fragenliste im Admin.
const QUESTIONS = [
...
// count/label kommen aus dem Admin — siehe LeadMagnetSection.
export default function LeadMagnetSectionView({
  count,
  label,
}: {
  count: number;
            ...
            <div className="mt-7 grid gap-8 sm:mt-8 md:grid-cols-2 md:gap-12">
              ...
              >
                <p className="text-text-secondary">
                  Keine To-do-Liste. Kein Leistungsdruck. Nur {count} ehrliche{" "}
                  {questionWord(count)}, die dich dabei unterstützen, dich

  ...
  return (
    <section className="scroll-mt-32 px-6 py-16 sm:py-24">
      <Reveal className="mx-auto max-w-4xl">
        <div className="relative overflow-hidden rounded-[2rem] bg-ivory text-center ring-1 ring-sage/20">
          <Reveal>
          ...
          <div className="relative mx-auto max-w-2xl px-6 pb-12 sm:px-14 sm:pb-16">
            <Reveal>
              <h2 className="mt-8 font-serif text-3xl leading-snug text-text-primary sm:mt-10 sm:text-4xl">
                15 Reflexionsfragen für{" "}
                <span className="text-gold whitespace-nowrap">mehr Klarheit</span>
              </h2>
            ...
            <Reveal delay={0.1}>
              ...
              <button
                ...
                className="group relative mt-9 inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-sage px-6 py-3.5 text-sm font-medium whitespace-nowrap text-ivory shadow-[0_8px_24px_-6px_rgba(143,175,138,0.55)] ring-1 ring-sage/30 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_14px_32px_-6px_rgba(143,175,138,0.65)] sm:w-auto sm:px-10 sm:py-3.5 sm:text-base"
              >
                <span
                  aria-hidden
